...
peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-vicuna-13b-hf-lora-recurrent-user-noLS-yesno-e1-r8"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-vicuna-13b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e1-r8-new-llm全layer-numeric-测试是否qlora"
