...
# ⚠️ 更新保存路径以反映新模型
SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/Qwen2.5-VL/qwen2.5-vl-3b-lora-recurrent-user-noLS-{prompt_template}-e{EPOCH}-r{LORA_R}"

# ⚠️ 确保这个数据集里 'ground_truth' 是 'yes'/'no'
datapath = f"MicroLens-50k-training-recurrent-noLS-reason-imagePath"
