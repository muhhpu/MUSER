...
dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/MicroLens-50k-train-recurrent-longshortpreference-reason-new-numeric")
...
if __name__ == "__main__":
    ...
    updated_dataset = dataset.map(
        ...
        num_proc=7  # one process per GPU
    )
