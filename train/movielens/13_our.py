...
REPO_ID = "yeyuyang95/llava-v1.6-vicuna-13b-hf"
WANDB_PROJECT = "LLaVaNeXT"
WANDB_NAME = "llava-v1.6-vicuna-13b-hf"

location = "kua"

SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/movielens-13B-lora-recurrent-user-longshort-finetunereason-{location}-linear1-e{EPOCH}-r{LORA_R}-numeric"
