...
train_pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/microlens/preprocessing/train_pairs.csv"
df_train = pd.read_csv(train_pair_file_path)
df_train['item'] = df_train['item'].astype(str)
df_train['user'] = df_train['user'].astype(str)

val_pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/microlens/preprocessing/val_pairs.csv"
...
# user_pref_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/Inference/microlens/user_preference_recurrent_增强了可读性.csv"
# user_pref_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/Inference/microlens/store/user_preference_recurrent_增加了score.csv"
# user_pref_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/Inference/microlens/user_preference_recurrent_numeric.csv"
...
item_title_file_path = "/home/team//MicroLens-50k-Dataset/MicroLens-50k_titles.csv"
...
folder_path = "/home/team//MicroLens-50k-Dataset/MicroLens-50k_covers"
...
# reasons_file = "/home/team//MLLM-MSR-main/MLLM-MSR/deepseek/train_pairs_with_reasons_merged.csv"
reasons_file = "/home/team//MLLM-MSR-main/MLLM-MSR/deepseek/train_pairs_with_reasons_numeric_merged.csv"
# reasons_file = "/home/team//MLLM-MSR-main/MLLM-MSR/deepseek/train_pairs_with_reasons_score_merged.csv"
...
dataset.save_to_disk("MicroLens-50k-training-recurrent-noLS-yesno")
# dataset.save_to_disk("MicroLens-50k-training-recurrent-longshortpreference-reason-new-numeric-imagePath-validatreason")
