...
base_model_id = "/home/team//MLLM-MSR-main/MLLM-MSR/train/llava-v1.6-vicuna-13b-hf/"

# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/ninerec-13B-lora-recurrent-user-noLS-yesno-e1-r8"
peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/ninerec-13B-lora-recurrent-user-longshort-finetunereason-kua-linear1-e1-r8-numeric"
...
dataset = dataset.select(range(1260))
# print(dataset)
