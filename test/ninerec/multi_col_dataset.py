...
# pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/ninerec/Downstream_datasets/Bili_Movie/preprocessing/processed_bili/test_pairs_new.csv"
pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/ninerec/Downstream_datasets/Bili_Movie/preprocessing/processed_bili/test_pairs.csv"
df = pd.read_csv(pair_file_path)
df['item'] = df['item_id'].astype(str)
...
reasons_file = "/home/team//MLLM-MSR-main/MLLM-MSR/deepseek/ninerec/ninerec_test_pairs_with_reasons_numeric_merged.csv"
...
# )
df['prompt'] = df.apply(lambda x: prompt_text.format(x['preference'], x['title_en']), axis=1)
...
dataset = dataset.select(range(4200))

# 检查数据集结构
print(dataset)

# dataset.save_to_disk("ninerec-test-recurrent_noLS-yesno")
dataset.save_to_disk("ninerec-test-recurrent_noLS-yesno-imagepath")
# dataset.save_to_disk("ninerec-test-recurrent-longshortpreference-reason-new-numeric-testreason")
# dataset.save_to_disk("ninerec-test-recurrent-longshortpreference-reason-new-numeric-imagepath")
# dataset.save_to_disk("ninerec-test-recurrent-longshortpreference-reason-new-numeric-testreason-explainability")
