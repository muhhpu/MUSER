...
base_model_id = "/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/train/llava-v1.6-mistral-7b-hf/"
...
# peft_model_id = "/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-e4-r16"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-yesno-e4-r8"
peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-noLS-yesno-e4-r8"
# 微调reason后
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-e4-r8"
# 跨模态和llm中高层ffn
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-e4-r8"
# 跨模态和llm中高层ffn+dynamic调整俩taskloss
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-dynamic-e4-r8"
# 设置两个任务loss权重为可学习的参数。
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear-e4-r8"
# 增加了两个任务loss参数的lr*5
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8"
# 测试r16
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16"
# 测试4
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r4"
# 恢复原结果
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r4-new"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16-new"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16-new-llm全layer"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e2-r16-new-llm全layer-numeric"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric-双惩loss"
# peft_model_id = f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric-notbad"
#
...
# /home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/MicroLens-50k-training-recurrent
# dataset = load_from_disk(f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/MicroLens-50k-train-recurrent-longshortpreference-{prompt_template}-new-numeric")
dataset = load_from_disk(f"/home/team/caoziyi/MLLM-MSR-main/MLLM-MSR/MicroLens-50k-test-recurrent-longshortpreference-reason-new-numeric-testreason")
...
def gpu_computation(batch, rank):
    ...
    with torch.no_grad() and autocast():
        outputs = model.generate(**model_inputs, max_new_tokens=350, return_dict_in_generate=True, output_scores=True)
    ...
    for i in range(len(batch['output'])):
        pred_text = clean_text(batch['output'][i].replace("[/INST]", "")).strip()
...
def compute_all_metrics(preds, refs):
    ...
    usr = len(unique_preds) / len(preds) if len(preds) > 0 else 0
    ...
    for pred, ref in zip(preds, refs):
        # Ensure strings are valid for processing
        ...
        # BLEU
        # Handle empty reference or prediction for BLEU to avoid warnings/errors
        ...
        if not ref_tokens or not pred_tokens:
            ...
            bleu1_scores.append(
                sentence_bleu([ref_tokens], pred_tokens, weights=(1, 0, 0, 0), smoothing_function=smooth))
            bleu4_scores.append(
        ...
        # --- FIX STARTS HERE ---
        if not pred:
            # If prediction is empty, scores are 0
            scores = {
                'rouge-1': {'p': 0.0, 'r': 0.0, 'f': 0.0},
                'rouge-2': {'p': 0.0, 'r': 0.0, 'f': 0.0}
            }
        elif not ref:
            # If reference is empty, scores are 0 (though unlikely in valid datasets)
            scores = {
                'rouge-1': {'p': 0.0, 'r': 0.0, 'f': 0.0},
                'rouge-2': {'p': 0.0, 'r': 0.0, 'f': 0.0}
            }
            ...
            try:
                ...
                # Catch any other specific edge cases from rouge
                scores = {
                    'rouge-1': {'p': 0.0, 'r': 0.0, 'f': 0.0},
                    'rouge-2': {'p': 0.0, 'r': 0.0, 'f': 0.0}
                }
...
if __name__ == "__main__":
    ...
    # ===== GPTScore: LLM-as-judge semantic evaluation =====
    # Before running, set your API key:
    #   export OPENAI_API_KEY="your_api_key"
    # The exact judge model snapshot should be reported in the paper.
    gptscore, gpt_details = evaluate_gptscore_pairs(
        preds,
        refs,
        model="gpt-4o-2024-08-06",
        temperature=0.0,
        cache_dir="./gptscore_cache"
    )
    metrics["GPTScore"] = gptscore
