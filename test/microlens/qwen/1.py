...
dataset_path = "/home/team//MLLM-MSR-main/MLLM-MSR/MicroLens-50k-test-recurrent-longshortpreference-reason-new-numeric-imagepath"

# PEFT_MODEL_ID = "/home/team//MLLM-MSR-main/MLLM-MSR/save/Qwen2.5-VL/qwen2.5-vl-3b-lora-recurrent-user-noLS-yesno-e4-r8"
# dataset_path = "/home/team//MLLM-MSR-main/MLLM-MSR/MicroLens-50k-test-recurrent_noLS-yesno-imagepath"

dataset = load_from_disk(dataset_path)
dataset = dataset.select(range(2100))  # 限制数据量，参考 yn.py
