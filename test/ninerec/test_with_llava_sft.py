...
peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/ninerec-7b-recurrent-user-LS-yesno-e2-r8-yesno"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/ninerec-7b-recurrent-user-noLS-yesno-e2-r8"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/ninerec-7b-recurrent-user-longshort-finetunereason-kua-linear1-e2-r8-new-llm全layer-numeric"
...
# dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/ninerec-test-recurrent_noLS-yesno")
dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/ninerec-test-recurrent-longshortpreference-reason-new-numeric-testreason")
...
if __name__ == "__main__":
    ...
    updated_dataset = dataset.map(
        ...
        num_proc=5  # one process per GPU
    )
