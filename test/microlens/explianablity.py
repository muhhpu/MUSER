...
# peft_model_id = "/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-e4-r16"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-yesno-e4-r8"
peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-noLS-yesno-e4-r8"
# 微调reason后
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-e4-r8"
# 跨模态和llm中高层ffn
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-e4-r8"
# 跨模态和llm中高层ffn+dynamic调整俩taskloss
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-dynamic-e4-r8"
# 设置两个任务loss权重为可学习的参数。
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear-e4-r8"
# 增加了两个任务loss参数的lr*5
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8"
# 测试r16
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16"
# 测试4
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r4"
# 恢复原结果
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r4-new"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16-new"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r16-new-llm全layer"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e2-r16-new-llm全layer-numeric"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric-双惩loss"
# peft_model_id = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-mistral-7b-hf-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-new-llm全layer-numeric-notbad"
#
...
dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/MicroLens-50k-test-recurrent-longshortpreference-reason-new-numeric-testreason")
...
if __name__ == "__main__":
    ...
    updated_dataset = dataset.map(
        ...
        num_proc=2  # one process per GPU
    )
    # ===== 调用指标计算 =====
