...
REPO_ID = "yeyuyang95/llava-v1.6-34b-hf-lora"
WANDB_PROJECT = "LLaVaNeXT"
WANDB_NAME = "llava-v1.6-34b-hf-lora"
SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-34b-hf-lora-recurrent-user-noLS-{prompt_template}-e{EPOCH}-r{LORA_R}"
...
class LlavaModelPLModule(L.LightningModule):
    ...
    def validation_step(self, batch, batch_idx, dataset_idx=0):
        ...
        generated_ids = self.model.generate(input_ids=input_ids, attention_mask=attention_mask,
                                            pixel_values=pixel_values, image_sizes=image_sizes, max_new_tokens=256)
