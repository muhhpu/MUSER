...
pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/microlens/preprocessing/test_pairs.csv"
# pair_file_path = "/home/team//MLLM-MSR-main/MLLM-MSR/data/microlens/preprocessing/test_pairs_new.csv"
...
reasons_file = "/home/team//MLLM-MSR-main/MLLM-MSR/deepseek/test_pairs_with_reasons_numeric_whole.csv"
...
reasons_df['label'] = reasons_df['label'].astype(int)
...
dataset.save_to_disk("MicroLens-50k-test-recurrent_noLS-yesno")
# dataset.save_to_disk("MicroLens-50k-test-recurrent-longshortpreference-reason-new-numeric")
