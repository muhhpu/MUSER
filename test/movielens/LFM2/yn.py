...
PEFT_MODEL_ID = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LFM2-VL/movie-lfm2-vl-450m-lora-yesno_lfm2-e4-r8"
dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/movielens-test-recurrent-noLS-yesno-imagepath")

# PEFT_MODEL_ID = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LFM2-VL/movie-lfm2-vl-450m-lora-recurrent-user-longshort-finetunereason-kua-linear1-e4-r8-numeric"
# dataset = load_from_disk(f"/home/team//MLLM-MSR-main/MLLM-MSR/movielens-test-recurrent-longshortpreference-reason-numeric-imagepath")
