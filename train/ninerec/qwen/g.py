...
# ⚠️ 更新保存路径以反映新模型
SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/Qwen2.5-VL/ninrec-qwen2.5-vl-3b-lora-recurrent-user-longshort-finetunereason-{location}-linear1-e{EPOCH}-r{LORA_R}-new-llm全layer-numeric-双惩loss"
...
# ------------------ Dataset -------------------
dataset_path = "/home/team//MLLM-MSR-main/MLLM-MSR/ninerec-training-recurrent-longshortpreference-reason-numeric-imagepath"
