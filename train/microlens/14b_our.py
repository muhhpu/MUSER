...
# LORA_R = 16
MODEL_ID = "/home/team//MLLM-MSR-main/MLLM-MSR/train/llava-v1.6-vicuna-13b-hf/"

REPO_ID = "yeyuyang95/llava-v1.6-vicuna-13b-hf-lora"
WANDB_PROJECT = "LLaVaNeXT"
WANDB_NAME = "llava-v1.6-vicuna-13b-hf-lora"

location = "kua"


SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-vicuna-13b-hf-lora-recurrent-user-longshort-finetunereason-{location}-linear1-e{EPOCH}-r{LORA_R}-new-llm全layer-numeric-测试是否qlora"
