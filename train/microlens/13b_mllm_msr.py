...
SAVE_DIR = f"/home/team//MLLM-MSR-main/MLLM-MSR/save/LLaVA/llava-v1.6-vicuna-13b-hf-lora-recurrent-user-noLS-{prompt_template}-e{EPOCH}-r{LORA_R}"


datapath = f"/home/team//MLLM-MSR-main/MLLM-MSR/MicroLens-50k-training-recurrent-noLS-{prompt_template}"
